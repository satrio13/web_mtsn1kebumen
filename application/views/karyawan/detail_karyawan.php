<div class="container">
    ...
    <?php if($data->gambar != '' AND file_exists("assets/img/karyawan/$data->gambar")){ ?> 
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center">
                <a href="<?= base_url("assets/img/karyawan/$data->gambar"); ?>" class="image-link">
                    <img src="<?= base_url("assets/img/karyawan/$data->gambar"); ?>" class="img img-fluid" width="150px">
                </a>
            </div>
        </div>
    <?php } ?>
