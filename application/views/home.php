<div class="owl-carousel owl-theme">
    <?php     
    foreach($banner->result() as $r):
        echo'<div style="max-height:600px">
                <img class="img-fluid w-100 d-block" src="'.base_url("assets/img/banner/$r->gambar").'">
                                ...
                                <div class="card-body p-1">
                                    <div class="card-img">
                                        <a href="'.base_url("agenda/detail/$r->slug").'">
                                            <img src="'.base_url("assets/img/agenda/$img").'" class="img img-fluid mt-2" style="height: 150px; object-fit: contain;">
                                            '.$status.'
                                        </a>
                                    </div>
                                    <div class="card-desc">
                                ...
                                <div class="card-body p-1">
                                    <div class="card-img">
                                        <a href="'.base_url("pengumuman/detail/$r->slug").'">
                                            <img src="'.base_url("assets/img/pengumuman/$img").'" class="img img-fluid mt-2" style="height: 150px; object-fit: contain;">
                                        </a>
                                    </div>
                                    <div class="card-desc">
                                        <h5>
                                        ...
                                        <span class="badge badge-primary"><i class="fa fa-calendar"></i> '.tgl_indo($r->tgl).'</span>
                                        <span class="badge badge-danger"><i class="fa fa-clock-o"></i> '.date('H:i', strtotime($r->tgl)).'</span> 
                                        <hr>
                                ...
                                <div class="card-body p-1">
                                    <div class="card-img">
                                        <a href="'.base_url("berita/detail/$r->slug").'">
                                            <img src="'.base_url("assets/img/berita/$img").'" class="img img-fluid mt-2" style="height: 150px; object-fit: contain;">
                                        </a>
                                    </div>
                                    <div class="card-desc">
                                        <h5>
                            ...
                            if($download->num_rows() > 0)
                            {
                                foreach($download->result() as $r):
                                    echo'<li class="list-group-item text-break">
                                            ...
                                            <br><small class="text-muted"><b><i class="fa fa-calendar"></i> '.tgl_indo($r->tgl_upload).' | <i class="fa fa-download"></i> '.$r->hits.' x</b></small>
                                        </li>';
                                endforeach;
                            }else
                            {
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-12 p-2">
                        <ul class="list-group">
                            <?php
                            if($ekstrakurikuler->num_rows() > 0)
                            {
                                foreach($ekstrakurikuler->result() as $r):
                                    echo'<li class="list-group-item text-break">
                        ...
                        foreach($video->result() as $r): 
                            echo'<div class="col-md-6 mb-3 mt-3 text-break">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-footer">
                                            <small><i class="fa fa-calendar"></i> '.tgl_indo($r->uploaded_on).' <i class="fa fa-clock-o"></i> '.date('H:i', strtotime($r->uploaded_on)).' WIB</small>
                                        </div>
                                    </div>
                                </div>';
                        endforeach; 
                ...
                <div class="row m-1 border">
                    <div class="col-md-12">
                        ...
                        {    
                            ...
                            foreach($alumni->result() as $r):
                                if( !empty($r->gambar) AND file_exists("assets/img/alumni/$r->gambar") )
                                {
                                    $img = $r->gambar;
                                }else
                                {
                                ...
                                echo'<div class="text-break ml-5 mr-5">
                                        <img src="'.base_url("assets/img/alumni/$img").'" class="img img-fluid mt-4" style="object-fit:contain; max-height:100px;">
                                        <p class="text-center">" '.cetak($r->kesan).' "</p>
                                        <p class="text-center"><b>'.cetak($r->nama).'</b></p>
                                    </div>';
                            endforeach;
                            echo'</div>';
                        }else
                ...
                <div class="row m-1 border">
                    <div class="col-md-12 text-center">
                        <a href="<?= base_url('pengaduan'); ?>" title="Klik Disini untuk menuju halaman pengaduan <?= title(); ?>">
                            <img src="<?= base_url("assets/file/pengaduan.png"); ?>" class="img img-fluid mt-2 mb-2" style="height: 120px; object-fit: contain;">
                        </a>
                    </div>
                </div>       
            </div>
