    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered table-striped table-sm">
                ...
                <tbody>
                    <?php 
                    if($kelompok_a->num_rows() > 0)
                    {
                        $jml_alokasi_a = 0;
                        $no = 1; 
                        foreach($kelompok_a->result() as $a):
                    ...
                    if($kelompok_b->num_rows() > 0)
                    {
                        $jml_alokasi_b = 0;
                        $no = 1; 
                        foreach($kelompok_b->result() as $b):
                    ...
                    if($kelompok_c->num_rows() > 0)
                    {
                        $jml_alokasi_c = 0;
                        $no = 1; 
                        foreach($kelompok_c->result() as $c):
