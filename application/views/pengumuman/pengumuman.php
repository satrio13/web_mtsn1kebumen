<section id="agenda" class="pt-3 pb-5">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <form method="GET" action="<?= base_url('pengumuman/search'); ?>">
                    <div class="input-group">
                        <input type="text" name="q" value="<?= cetak($cari); ?>" class="form-control" placeholder="cari pengumuman" required>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                Hasil pencarian menggunakan keyword: <?= cetak($cari); ?>
            </div>
        </div>
        <?php } ?>
        <div class="row">
                            ...
                            <div class="card h-100">
                                <div class="card-body p-1">
                                    ...
                                    <div class="card-desc">
                                        ...
                                        <span class="badge badge-primary"><i class="fa fa-clock-o"></i> '.tgl_indo($r->tgl).'</span>
