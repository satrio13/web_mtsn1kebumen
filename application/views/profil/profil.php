<div class="container">
    ...
    <?php if($data->gambar != '' AND file_exists("assets/img/profil/$data->gambar")){ ?>
        <div class="row">
            <div class="col-md-12 text-center">
                <img src="<?= base_url("assets/img/profil/$data->gambar"); ?>" class="img img-fluid"><br><br>
            </div>
        </div>
    <?php } ?>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-9"><b>:</b>
            <?php 
            if($data->file != '' AND file_exists("assets/file/$data->file"))
            { 
