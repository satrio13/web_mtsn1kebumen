    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 text-break">
                <div class="row">
                    <?php if($data->gambar != '' AND file_exists("assets/img/agenda/$data->gambar")){ ?>
                        <div class="col-md-12">
                            <a href="<?= base_url("assets/img/agenda/$data->gambar"); ?>" class="image-link">
                                <img src="<?= base_url("assets/img/agenda/$data->gambar"); ?>" class="img img-fluid"><br>
                            </a>
                        </div>
                    <?php } ?>
                    <div class="col-md-12">
