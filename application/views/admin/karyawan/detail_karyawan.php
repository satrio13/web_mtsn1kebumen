        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="row mt-2">
                            <div class="col-md-12 text-bold text-white bg-info p-1">DETAIL KARYAWAN</div>
                        </div>
                    </div>
                    <div class="col-md-12 border border-secondary">
                        <div class="row mt-4">
                            <div class="col-md-12 text-center">
                                <?php 
                                if(!empty($data->gambar) AND file_exists("assets/img/karyawan/$data->gambar"))
                                {
                                    echo'<img src="'.base_url("assets/img/karyawan/$data->gambar").'" class="img img-fluid" width="120px">';
                                }
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-10">: <?= $data->tugas; ?></div>
                        </div>
                        <div class="row mt-2">
