...
$tugas = isset($_POST['submit']) ? $this->input->post('tugas', TRUE) : $data->tugas;
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="icheck-primary d-inline">
                                <input type="radio" name="statuspeg" value="PTT" id="radioPrimary3" <?php if($statuspeg == 'PTT'){ echo'checked'; } ?> > 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="tugas" maxlength="50" value="<?= $tugas; ?>" class="form-control" placeholder="TUGAS">
                        </div>
                    </div>
                    <div class="form-group row">
