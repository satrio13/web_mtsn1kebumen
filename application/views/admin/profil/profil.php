                ...
                <div class="card-body">
                    <div class="col-md-12">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-10">: 
                                                    <img src="<?= base_url("assets/img/logo/$data->logo_web"); ?>" style="object-fit:contain; max-height:150px;">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-10">: 
                                                    <img src="<?= base_url("assets/img/logo/$data->favicon"); ?>" style="object-fit:contain; max-height:30px;">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-10">: 
                                                    <img src="<?= base_url("assets/img/logo/$data->logo_admin"); ?>" style="object-fit:contain; max-height:150px;">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-10">: 
                                                    ...
                                                    {
                                                        echo'<img src="'.base_url("assets/img/profil/$data->gambar").'" style="object-fit:contain; max-height:150px;">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-10">: 
                                                    ...
                                                    if(!empty($data->file))
                                                    { 
                                                        echo'<b><a href="'.base_url("assets/file/$data->file").'" target="_blank">'.$data->file.'</a></b><br>
