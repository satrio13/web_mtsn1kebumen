<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
        <div class="col-12">
            <?php 
              if($this->session->flashdata('msg-gagal-gambar'))
              {
                echo pesan_gagal($this->session->flashdata('msg-gagal-gambar'));
              }
            ?>
            <div class="card card-primary">
                ...
                <?php echo form_open_multipart('backend/gambar-profil','id="form"'); ?>
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <?php }else{ ?>
                            Gambar Sekarang: <img class='img-responsive mb-2' id='preview_gambar' width='150px' src="<?= base_url(); ?>assets/img/profil/<?= $data->gambar; ?>">
                        <?php } ?>
