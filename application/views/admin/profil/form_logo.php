<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
        <div class="col-12">
            <?php 
              if($this->session->flashdata('msg-gagal-logo'))
              {
                echo pesan_gagal($this->session->flashdata('msg-gagal-logo'));
              }
            ?>
            <div class="card card-primary">
                ...
                <?php echo form_open_multipart('backend/logo-web','id="form"'); ?>
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <?php }else{ ?>
                            Logo Sekarang: <img class='img-responsive mb-2' id='preview_gambar' width='150px' src="<?= base_url(); ?>assets/img/logo/<?= $data->logo_web; ?>">
                        <?php } ?>
