        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?=base_url();?>backend/tambah-siswa" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
                        ...
                        <table class="table table-bordered table-striped table-sm" id="datatable">
                            ...
                            <tr>
                                ...
                                <td class="text-center" nowrap>
                                    <a href="<?= base_url("backend/edit-siswa/$r->id_siswa"); ?>" class="btn btn-info btn-xs" title="EDIT DATA">EDIT</a>
