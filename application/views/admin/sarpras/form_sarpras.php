      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('backend/sarpras'); ?>">Sarpras</a></li>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <?php echo form_open('backend/edit-sarpras'); ?>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">SARANA DAN PRASARANA</label>
                        <div class="col-sm-8">
