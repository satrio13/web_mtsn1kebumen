<?php
$tahun = isset($_POST['submit']) ? $this->input->post('tahun', TRUE) : $data->tahun;
?>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <?php echo form_open('backend/edit-tahun-pelajaran/'.$this->uri->segment('3'), 'id="form"'); ?>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">TAHUN PELAJARAN <span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="tahun" maxlength="10" value="<?= $tahun; ?>" class="form-control required" placeholder="TAHUN PELAJARAN">
