        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?= base_url('backend/tambah-prestasi-siswa'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Prestasi</a>
                ...
                <div class="card-body">
                    <div class="table table-responsive">
                        <table class="table table-bordered table-striped table-sm" id="table-prestasi-siswa">
