...
$nama_siswa = isset($_POST['submit']) ? $this->input->post('nama_siswa', TRUE) : $data->nama_siswa;
$kelas = isset($_POST['submit']) ? $this->input->post('kelas', TRUE) : $data->kelas;
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <?php echo form_open_multipart('backend/edit-prestasi-siswa/'.$this->uri->segment('3'), 'id="form"'); ?>
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nama_siswa" maxlength="100" value="<?= $nama_siswa; ?>" class="form-control" placeholder="NAMA SISWA">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">KELAS</label>
                        <div class="col-sm-3">
                            <input type="text" name="kelas" maxlength="6" value="<?= $kelas; ?>" class="form-control" placeholder="KELAS">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <?php }else{ ?>
                                <img class='img-responsive' id='preview_gambar' width='150px' src="<?= base_url(); ?>assets/img/prestasi/siswa/<?= $data->gambar; ?>">
                            <?php } ?>
