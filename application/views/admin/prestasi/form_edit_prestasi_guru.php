...
$nama_guru = isset($_POST['submit']) ? $this->input->post('nama_guru', TRUE) : $data->nama_guru;
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nama_guru" maxlength="100" value="<?= $nama_guru; ?>" class="form-control" placeholder="NAMA GURU">
                        </div>
                    </div>
                    <div class="form-group row">
