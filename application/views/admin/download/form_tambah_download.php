    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <?php echo form_open_multipart('backend/tambah-download','id="form"'); ?>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">NAMA FILE <span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" name="nama_file" maxlength="100" value="<?= set_value('nama_file'); ?>" class="form-control required" placeholder="NAMA FILE">
