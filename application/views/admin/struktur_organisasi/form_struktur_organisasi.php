    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <?php echo form_open_multipart('backend/edit-struktur-organisasi'); ?>
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <?php }else{ ?>
                            <img class='img-responsive' id='preview_gambar' width='150px' src="<?= base_url(); ?>assets/img/struktur/<?= $data->isi; ?>">
                        <?php } ?>
