    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <?php echo form_open('backend/tambah-link','id="form"'); ?>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">NAMA HALAMAN <span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="nama" maxlength="100" value="<?= set_value('nama'); ?>" class="form-control required" placeholder="NAMA HALAMAN">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="url" name="link" value="<?= set_value('link'); ?>" class="form-control required" placeholder="LINK URL">
