    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <?php echo form_open('backend/tambah-album','id="form"'); ?>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">NAMA ALBUM <span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="album" maxlength="100" value="<?= set_value('album'); ?>" class="form-control required" placeholder="NAMA HALAMAN">
