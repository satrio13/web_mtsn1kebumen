            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="album" maxlength="100" value="<?= $album; ?>" class="form-control required" placeholder="NAMA HALAMAN">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <div class="icheck-primary d-inline">
                                <input type="radio" name="is_active" value="1" id="radioPrimary1" <?php if($is_active == '1'){ ?> checked <?php } ?> > 
                                <label for="radioPrimary1">Aktif</label> 
                                &nbsp;&nbsp;&nbsp; 
                            </div>
                            <div class="icheck-primary d-inline">
                                <input type="radio" name="is_active" value="0" id="radioPrimary2" <?php if($is_active == '0'){ ?> checked <?php } ?> > 
