<div class="container">
    ...
    <div class="row">
        <div class="col-md-12"><h3><b>PRESTASI MADRASAH</b></h3><hr></div>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    {   
                        ...
                        foreach($data->result() as $r):
                            ...
                            {
                                $img = '<a href="'.base_url("assets/img/prestasi/sekolah/$r->gambar").'" class="image-link">
                                            <img src="'.base_url("assets/img/prestasi/sekolah/$r->gambar").'" class="img img-fluid">
                                        </a>'; 
                            }else
                            {
                                $img = '';
